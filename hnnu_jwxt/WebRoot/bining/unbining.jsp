...
<body>
 ...
 <br /><br />
	...
	<div align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#5f5f5f"><b>解绑说明</b></font>
		<ul>
		<li>解除绑定后我们将把您的个人信息，包括用户名密码及个人自定义课表等从系统移除</li>
		<li>解除绑定后您将不能使用【学生专区】和【教师专区】的所有功能，但可以正常使用【公共服务】的所有功能</li>
		<li>如您对我们的产品有意见或建议，请在【公共服务】-【教学反馈】中写上您宝贵的意见。感谢您的使用，期待您的再次绑定！</li>
		<li></li>
		</ul>
	   </div>
		</font> 
		...
		<form action="<%=basePath%>bining/doUnBining.jsp" method="get">
			<input type="hidden" name="openID"
				value="<%=request.getParameter("openID").toString()%>" />
					<%
		if(isbining){//已绑定
			out.append("<input type=\"submit\" value=\"确定解除绑定\" />");
		}else{//未绑定
			out.append("<input type=\"submit\" disabled value=\"您还未绑定，无法解绑！\" />");
