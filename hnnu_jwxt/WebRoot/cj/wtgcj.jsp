...
/*		window.onload = function() {
	...
	function updatecj() {
		...
		window.setTimeout(
				"window.location='http://www.hainnujwc.com/hnnu_jwxt/cj/wtgcj.jsp?openID="
		...
		<div data-role="content" text-shadow="none">
			...
			<%
				try {
					...
					DB db = new DB();
					zcj_map = (Map) db.getWTGCJ(openID);
					db = null;
					...
					out.print("</div><a href=\"#\" data-role=\"button\" onclick=\"updatecj();\">重新载入成绩</a> <br /></div>");
