...
public class DBstukebiao {

	private final static DBstukebiao instance = new DBstukebiao();

	public static final DBstukebiao getInstance() {
		return instance;
	}
	...
	private static final String DB_NAME = "stu_kebiao";
